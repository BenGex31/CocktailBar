...
export const cocktailList = [
  ...
  new Cocktail("sex on the beach", sexOnTheBeach, [
    "3 cl vodka",
    "5 cl jus ananas",
    "2 cl crème de pêche",
    "10 cl cramberrie",
  ...
  new Cocktail("dry martini", dryMartini, ["5 cl gin", "2 cl martini"]),
  new Cocktail("gimlet", gimlet, ["8 cl gin", "2 cl lime cordial"]),
  ...
  new Cocktail("tequila sunrise", tequila_sunrise, [
    "6 cl tequila",
    "12 cl jus d'orange",
    "2 cl sirop grenadine",
  ]),
  ...
  new Cocktail("vodka orange", vodka_orange, [
    "4 cl vodka",
    "12 cl jus d'orange",
  ]),
